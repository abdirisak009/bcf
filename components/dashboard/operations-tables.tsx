      ...
      <Sheet open={open} onOpenChange={setOpen}>
        <SheetContent side="right" className={dashboardSheetWide}>
          <div className={dashboardSheetHeader}>
            ...
            <SheetDescription className={cn('mt-2', dashboardSheetDescription)}>
              Upload a logo (JPG, PNG, or PDF per server limits). Stored in Cloudinary (HTTPS URL). Order controls how the home page lists clients (lower first).
            </SheetDescription>
          </div>
          <form onSubmit={submit} className={dashboardSheetForm}>
            <div className={cn(dashboardSheetBody, 'space-y-4')}>
      ...
      <Sheet open={open} onOpenChange={setOpen}>
        <SheetContent side="right" className={dashboardSheetWide}>
          <div className={dashboardSheetHeader}>
            ...
            <SheetDescription className={cn('mt-2', dashboardSheetDescription)}>
              Upload a logo. Stored in Cloudinary (HTTPS URL). Order controls how the home page lists partners (lower first).
            </SheetDescription>
          </div>
          <form onSubmit={submit} className={dashboardSheetForm}>
            <div className={cn(dashboardSheetBody, 'space-y-4')}>
